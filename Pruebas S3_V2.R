...
p_load(tidyverse,rio,
       ...
       osmdata,ggplot2, plotly,  nngeo, rgeos) # Get OSM's data
...
test_final_V3 <- st_as_sf(x=test_final_V3,coords=c("lon","lat"),crs=4326)
train_final_V3 <- st_as_sf(x=train_final_V3,coords=c("lon","lat"),crs=4326)
